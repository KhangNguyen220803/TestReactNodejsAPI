...
function SearchUser() {
  ...
  const { search } = useParams(); // Lấy mã sinh viên từ URL
  ...
  const fetchUsers = () => {
    fetch(`http://localhost:3000/api/searchUser/${search}`)
  ...
  return (
    <div className="container mt-5">
      <h1 className="text-center mb-4">Danh Sách Sinh Viên Cần Tìm</h1>
